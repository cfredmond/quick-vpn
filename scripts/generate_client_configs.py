...
for client in client_records:
    ...
    subprocess.Popen(f"/home/ec2-user/quick-vpn-main/scripts/generate_client_conf.sh {client[8]} {client[4]} {client[5]} {client[3]} {client[6]} {client[7]} {client[9]}", shell=True)
